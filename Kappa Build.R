...
save(forestmodel, file = "kappa/forestmodel.RData")
...
save(nbmodel, file = "kappa/nbmodel.RData")
...
save(svmmodel1, file = "kappa/svmmodel.RData")
...
save(xgboostmodel, file = "kappa/xgboostmodel.RData")
...
save(linmodel, file = "kappa/limodel.RData")
...
save(C50model, file = "kappa/c50model.RData")
...
# 
# save(ensembletinnertest, ensembletrain, ensembleindex, file = "kappa/ensembledata.RData")
...
ensembleSVMTuneGrid <- svmmodel1$bestTune
...
save(forestmodel, nbmodel, nnetmodel, svmmodel1, xgboostmodel, C50model, file = "kappa/modelsACC.RData")
save(ensembleRFmodel, ensembleNBmodel,
     ensembleNNETmodel,
     ensembleSVMmodel, ensemblexgboostmodel,
     file = "kappa/ensemble.RData")
save(EnsembleXGBoost, file = "kappa/finalensemble.RData")
